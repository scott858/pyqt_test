...
w.setCameraPosition(distance=10 * distance, azimuth=-90)
...
d = 6.0
color[0] = (255, 255, 0, .5)
color[1] = (255, 153, 51, .5)
color[2] = (255, 0, 255, .5)
color[3] = (0, 204, 255, .5)
color[4] = (255, 53, 50, .5)
color[5] = (153, 55, 200, .5)
color[6] = (204, 53, 100, .5)
color[7] = (0, 102, 255, .5)
color[8] = (20, 102, 255, .5)
color[9] = (100, 102, 255, .5)
